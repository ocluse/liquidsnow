...
public static class IOUtility
{
    ...
    /// </summary>
    /// <exception cref="TimeoutException">When the set timeout has elapsed</exception>
    ...
    /// </summary>
    /// <remarks>
    /// Useful if you do not wish to overwrite an existing file, but retain the name and number it. 
    ...
    /// </summary>
    /// <remarks>
    /// Useful if you do not wish to overwrite an existing directory, but retain the name and number it. 
