...
namespace Ocluse.LiquidSnow.Validations
{
    ...
    public partial class CommonValidators
    {
        ...
        /// </summary>
        public Task<ValidationResult> NumberGreaterThanZero<T>(T value) where T : INumber<T>
        {
            if (value == null)
            {
                return Task.FromResult(ValidationResult.NotValid(ValueRequiredMessage));
        ...
        /// </summary>
        public Task<ValidationResult> NumberLessThanZero<T>(T value) where T : INumber<T>
        {
            if (value == null)
            {
                return Task.FromResult(ValidationResult.NotValid(ValueRequiredMessage));
