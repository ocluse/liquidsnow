...
internal static class ExecutionsHelper
{
    ...
    public static async Task<TResult> ExecuteDescriptorAsync<TResult>(object execution, ExecutionDescriptor descriptor, IServiceProvider serviceProvider, CancellationToken cancellationToken)
    {
        ...
        if (preExecutionHandler != null)
        {
            ...
            else if (preExecutionResultType != typeof(PreExecutionResult.ContinueExecutionResult))
            {
