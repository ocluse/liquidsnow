...
public class Rotor : EnigmaWheel
{
    ...
    /// The second argument is true if the notch was hit in a counter-clockwise fashion. Otherwise false.
    /// </summary>
    ...
    /// </summary>
    /// <param name="window">The character desired to be in the window</param>
