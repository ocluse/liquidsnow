...
namespace Ocluse.LiquidSnow.Steganography
{
    ...
    /// </summary>
    /// <remarks>
    /// The <see cref="Jector"/> implementations typically hides data in the input by manipulating the least significant bits of the input media.
    /// </remarks>
    public abstract class Jector
    {
        ...
        ///</summary>
        /// <remarks>
        /// By default, the value is 2. Increasing the value may allow hiding more data, but may lead to noticeable artifacts in the produced output.
